        ...
        <>
            ...
            <div>
                <section className="py-1 bg-blueGray-50 w-full">
                    <div className="w-full xl:w-8/12 mb-8 px-3 mx-auto">
                        <div className="relative flex flex-col min-w-0 break-words bg-white dark:bg-slate-900 w-full mb-4 shadow-lg rounded">
